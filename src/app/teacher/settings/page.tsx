  ...
  return (
    <main className="container" style={{ padding: "48px 0 80px", maxWidth: 920 }}>
      ...
      <div style={{ marginTop: 24 }}>
        ...
        <p style={{ color: "var(--muted)", maxWidth: 640, lineHeight: 1.65, margin: "0 0 34px" }}>Identity and access stay centrally managed; only your own password can be changed here.</p>
      </div>
      <div style={{ display: "grid", gap: 14 }}>
        <section style={cardStyle}>
          <span className="eyebrow">Account</span>
          <div style={{ display: "grid", gap: 0, marginTop: 8 }}>
            {[["Name", user.displayName], ["Username", user.username ? `@${user.username}` : "—"], ["Role", user.role === "admin" ? "Admin access" : "Teacher"], ["Access", "Active"]].map(([label, value]) => (
